...
const CookieCard = () => {
  ...
  const cards = [
    { title: "Aadhar Service", link: "/Services/Adhar" },
    { title: "PAN Service", link: "/Services/Pan" },
    { title: "PF Service", link: "/Services/PF" },
    { title: "Resume", link: "/Services/Resume Creation"}
  ];
